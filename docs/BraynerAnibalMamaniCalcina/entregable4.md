...
| **TC-07** | Historial Local | Inferencia de traducción | Registro guardado en la lista | Tarjeta agregada y visualizada en el listado móvil | **Aprobado** |

##### Diagrama de Flujo de la Prueba de Inferencia por Voz
